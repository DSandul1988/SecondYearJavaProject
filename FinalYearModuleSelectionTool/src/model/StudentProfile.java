...
public class StudentProfile implements Serializable {
	...
	public StudentProfile(String a, String b ,Name n,  LocalDate d, Course e, Set<Module> s, Set<Module> r) {
		this.studentPnumber = a;
		this.studentName = n;
		this.studentEmail = b;
		this.studentDate = d;
		this.studentCourse = e;
		this.selectedModules =s;
		this.reservedModules=r;
